...
class TopFallsScreen extends StatelessWidget {
  ...
  static final List<Map<String, dynamic>> _top20Falls = [
    ...
    {'rank': 7, 'name': 'Pu\'uka\'oku Falls', 'height': '840 m', 'iso': 'US'},
    {'rank': 8, 'name': 'James Bruce Falls', 'height': '840 m', 'iso': 'CA'},
    {'rank': 9, 'name': 'Browne Falls', 'height': '836 m', 'iso': 'NZ'},
    {'rank': 10, 'name': 'Strupenfossen', 'height': '820 m', 'iso': 'NO'},
    {'rank': 11, 'name': 'Ramnefjellsfossen', 'height': '818 m', 'iso': 'NO'},
    {'rank': 12, 'name': 'Waihilau Falls', 'height': '792 m', 'iso': 'US'},
    {'rank': 13, 'name': 'Colonial Creek Falls', 'height': '788 m', 'iso': 'US'},
    {'rank': 14, 'name': 'Mongefossen', 'height': '773 m', 'iso': 'NO'},
    {'rank': 15, 'name': 'Gocta Cataracts', 'height': '771 m', 'iso': 'PE'},
    {'rank': 16, 'name': 'Mutarazi Falls', 'height': '762 m', 'iso': 'ZW'},
    {'rank': 17, 'name': 'Kjelfossen', 'height': '755 m', 'iso': 'NO'},
    {'rank': 18, 'name': 'Johannesburg Falls', 'height': '751 m', 'iso': 'US'},
    {'rank': 19, 'name': 'Yosemite Falls', 'height': '739 m', 'iso': 'US'},
    {'rank': 20, 'name': 'Trou de Fer Falls', 'height': '725 m', 'iso': 'FR'},
  ];
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'The tallest waterfalls by total vertical drop',
                    style: TextStyle(
                      fontSize: 14,
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return GestureDetector(
                    onTap: () {
                      if (landmark != null) {
                        _showLandmarkDetailsModal(context, landmark, const Color(0xFF00c6ff));
                      } else {
                          ...
                          Container(
                            ...
                            child: Text(
                              ...
                              style: TextStyle(
                                fontSize: 14,
                                fontWeight: FontWeight.bold,
                                color: rank <= 3 ? const Color(0xFF00c6ff) : Colors.grey[400],
                              ),
                            ),
                          ),
