...
const Color _kTheme = Color(0xFF8E7BA3);
              ...
              child: Column(
                ...
                children: [
                  Row(children: [
                    Container(
                      ...
                      child: Row(mainAxisSize: MainAxisSize.min, children: [
                        Icon(Icons.account_balance_rounded, size: 12, color: _kTheme),
                        const SizedBox(width: 4),
                        Text('Tallest Statues', style: TextStyle(fontSize: 11, fontWeight: FontWeight.w700, color: _kTheme)),
                      ]),
                    ),
                  ]),
                  ...
                  RichText(text: TextSpan(children: [
                    ...
                    const TextSpan(text: '\nTallest Statues', style: TextStyle(fontSize: 28, fontWeight: FontWeight.w900, color: Color(0xFF111827), letterSpacing: -1.0, height: 1.1)),
                  ])),
                  const SizedBox(height: 6),
                  Text('The world\'s tallest statues & monuments', style: TextStyle(fontSize: 13, color: Colors.grey[500], fontWeight: FontWeight.w500)),
                ],
              ),
            ),
