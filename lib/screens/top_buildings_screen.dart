...
const Color _kTheme = Color(0xFFB5838D);

class TopBuildingsScreen extends StatelessWidget {
  const TopBuildingsScreen({super.key});

  static final List<Map<String, dynamic>> _top20Buildings = [
          ...
          children: [
              ...
              child: Column(
                ...
                children: [
                  Row(children: [
                    Container(
                      ...
                      child: Row(mainAxisSize: MainAxisSize.min, children: [
                        Icon(Icons.apartment_rounded, size: 12, color: _kTheme),
                        const SizedBox(width: 4),
                        Text('Tallest Buildings', style: TextStyle(fontSize: 11, fontWeight: FontWeight.w700, color: _kTheme)),
                      ]),
                    ),
                  ]),
                  ...
                  RichText(text: TextSpan(children: [
                    ...
                    const TextSpan(text: '\nTallest Buildings', style: TextStyle(fontSize: 28, fontWeight: FontWeight.w900, color: Color(0xFF111827), letterSpacing: -1.0, height: 1.1)),
                  ])),
                  const SizedBox(height: 6),
                  Text('The world\'s highest skyscrapers', style: TextStyle(fontSize: 13, color: Colors.grey[500], fontWeight: FontWeight.w500)),
                ],
              ),
            ),
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemCount: _top20Buildings.length,
                itemBuilder: (context, index) {
                  final data = _top20Buildings[index];
                    ...
                    child: Container(
                      ...
                      child: Row(children: [
                        ...
                        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          const SizedBox(height: 3),
                          Text(height, style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: _kTheme.withOpacity(0.85))),
                        ])),
                        // 방문 여부
                        if (isVisited)
