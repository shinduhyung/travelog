...
const Color _kTheme = Color(0xFF6B9B9E);
...
class TopMuseumsScreen extends StatelessWidget {
  ...
  static final List<Map<String, dynamic>> _top20Museums = [
    {'rank': 1,  'name': 'Louvre Museum',                                        'city': 'Paris',         'iso': 'FR'},
    {'rank': 2,  'name': 'Metropolitan Museum of Art',                           'city': 'New York',      'iso': 'US'},
    {'rank': 3,  'name': 'British Museum',                                       'city': 'London',        'iso': 'GB'},
    {'rank': 4,  'name': 'Hermitage Museum',                                     'city': 'St. Petersburg','iso': 'RU'},
    {'rank': 5,  'name': 'Prado Museum',                                         'city': 'Madrid',        'iso': 'ES'},
    {'rank': 6,  'name': 'The Museum of Modern Art',                             'city': 'New York',      'iso': 'US'},
    {'rank': 7,  'name': 'Pergamon Museum',                                      'city': 'Berlin',        'iso': 'DE'},
    {'rank': 8,  'name': 'Uffizi Gallery',                                       'city': 'Florence',      'iso': 'IT'},
    {'rank': 9,  'name': "Musée d'Orsay",                                        'city': 'Paris',         'iso': 'FR'},
    {'rank': 10, 'name': 'Rijksmuseum',                                          'city': 'Amsterdam',     'iso': 'NL'},
    {'rank': 11, 'name': 'National Palace Museum',                               'city': 'Taipei',        'iso': 'TW'},
    {'rank': 12, 'name': 'National Gallery',                                     'city': 'London',        'iso': 'GB'},
    {'rank': 13, 'name': 'Kunsthistorisches Museum',                             'city': 'Vienna',        'iso': 'AT'},
    {'rank': 14, 'name': 'National Gallery of Art',                              'city': 'Washington D.C.', 'iso': 'US'},
    {'rank': 15, 'name': 'National Museum of Anthropology',                      'city': 'Mexico City',   'iso': 'MX'},
    {'rank': 16, 'name': 'Smithsonian National Museum of Natural History',       'city': 'Washington D.C.', 'iso': 'US'},
    {'rank': 17, 'name': 'Art Institute of Chicago',                             'city': 'Chicago',       'iso': 'US'},
    {'rank': 18, 'name': 'Tate Modern',                                          'city': 'London',        'iso': 'GB'},
    {'rank': 19, 'name': 'Acropolis Museum',                                     'city': 'Athens',        'iso': 'GR'},
    {'rank': 20, 'name': 'Victoria and Albert Museum',                           'city': 'London',        'iso': 'GB'},
  ];
              ...
              child: Column(
                ...
                children: [
                  Row(children: [
                    Container(
                      ...
                      child: Row(mainAxisSize: MainAxisSize.min, children: [
                        Icon(Icons.museum_rounded, size: 12, color: _kTheme),
                        const SizedBox(width: 4),
                        Text('Top Museums', style: TextStyle(fontSize: 11, fontWeight: FontWeight.w700, color: _kTheme)),
                      ]),
                    ),
                  ]),
                  ...
                  RichText(text: TextSpan(children: [
                    ...
                    TextSpan(text: '20', style: TextStyle(fontSize: 34, fontWeight: FontWeight.w900, color: _kTheme, letterSpacing: -1.5, height: 1.0)),
                    const TextSpan(text: '\nGlobal Museums', style: TextStyle(fontSize: 28, fontWeight: FontWeight.w900, color: Color(0xFF111827), letterSpacing: -1.0, height: 1.1)),
                  ])),
                  const SizedBox(height: 6),
                  Text('The world\'s most famous museums', style: TextStyle(fontSize: 13, color: Colors.grey[500], fontWeight: FontWeight.w500)),
                ],
              ),
            ),
