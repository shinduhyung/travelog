...
const Color _kTheme = Color(0xFF6B9DB8);
            ...
            Container(
              ...
              child: Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
                ...
                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Row(children: [
                    const Icon(Icons.water_rounded, size: 14, color: _kTheme),
                    const SizedBox(width: 5),
                    const Text('Largest Lakes', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: _kTheme, letterSpacing: 0.3)),
                  ]),
                  const SizedBox(height: 6),
                  const Text('Top 20 Largest',
                      style: TextStyle(fontSize: 28, fontWeight: FontWeight.w900, color: Color(0xFF111827), letterSpacing: -1.0, height: 1.1)),
                  const SizedBox(height: 4),
                  Text('The world\'s biggest lakes & inland seas', style: TextStyle(fontSize: 12, color: Colors.grey[500], fontWeight: FontWeight.w500)),
                ])),
                Consumer<LandmarksProvider>(builder: (context, provider, _) {
                  final visited = _top20Lakes.where((m) => provider.visitedLandmarks.contains(m['name'])).length;
                  return Container(
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final stat      = data['area'] as String;
                  ...
                  final barRatio  = (rawNum / 371000).clamp(0.0, 1.0);
