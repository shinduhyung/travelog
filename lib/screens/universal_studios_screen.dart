// lib/screens/universal_studios_screen.dart
...
class UniversalStudiosScreen extends StatelessWidget {
  const UniversalStudiosScreen({super.key});

  static final List<Map<String, dynamic>> _universalParks = [
    {'name': 'Universal Studios Hollywood', 'iso': 'US'},
    {'name': 'Universal Studios Japan',     'iso': 'JP'},
    {'name': 'Universal Studios Beijing',   'iso': 'CN'},
    {'name': 'Universal Studios Florida',   'iso': 'US'},
    {'name': 'Universal Studios Singapore', 'iso': 'SG'},
  ];
        ...
        child: Column(
          ...
          children: [
            Container(color: Colors.white, child: Column(children: [
              Container(height: 4, color: const Color(0xFF4facfe)),
              Padding(
                ...
                child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Container(width: 52, height: 52,
                      ...
                      child: const Icon(Icons.movie_filter_outlined, color: Color(0xFF4facfe), size: 26)),
                  const SizedBox(width: 14),
                  Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Text('Universal Studios', style: const TextStyle(fontSize: 11, fontWeight: FontWeight.w600,
                        color: Color(0xFF4facfe), letterSpacing: 0.6)),
                    const SizedBox(height: 3),
                    const Text('Universal Studios', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w900,
                        color: Color(0xFF111827), letterSpacing: -0.5, height: 1.1)),
                    const SizedBox(height: 4),
                    Text('Theme parks around the world', style: TextStyle(fontSize: 12, color: Colors.grey[500])),
                  ])),
                  const SizedBox(width: 12),
                  Consumer<LandmarksProvider>(builder: (context, provider, _) {
                    final seen = _universalParks.where((m) => provider.visitedLandmarks.contains(m['name'])).length;
                    ...
                    return Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.end, children: [
                      Row(mainAxisSize: MainAxisSize.min, children: [
                        Text('$seen', style: const TextStyle(fontSize: 26, fontWeight: FontWeight.w900,
                            color: Color(0xFF4facfe), height: 1.0)),
                        Padding(padding: const EdgeInsets.only(left: 3, top: 6),
                            child: Text(' / 5', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600,
                                color: const Color(0xFF4facfe).withOpacity(0.45), height: 1.0))),
                      ]),
                      const SizedBox(height: 5),
                      SizedBox(width: 56, child: ClipRRect(borderRadius: BorderRadius.circular(3),
                          child: Stack(children: [
                            Container(height: 4, color: const Color(0xFF4facfe).withOpacity(0.12)),
                            FractionallySizedBox(widthFactor: pct,
                                child: Container(height: 4, color: const Color(0xFF4facfe))),
                          ]))),
                    ]);
                  }),
                ]),
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemCount: _universalParks.length,
                itemBuilder: (context, index) {
                  final data      = _universalParks[index];
                  ...
                  return GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(color: isVisited ? const Color(0xFF4facfe).withOpacity(0.5) : Colors.grey[200]!, width: isVisited ? 1.5 : 1),
                      ...
                      child: Row(children: [
                        ...
                        if (isVisited)
                          Container(padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 4),
                              decoration: BoxDecoration(color: const Color(0xFF4facfe).withOpacity(0.12), borderRadius: BorderRadius.circular(12)),
                              child: Text('Visited',
                                  style: TextStyle(fontSize: 11, color: const Color(0xFF4facfe), fontWeight: FontWeight.w700)))
                        else
