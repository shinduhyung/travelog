// lib/screens/film_festivals_screen.dart
...
class FilmFestivalsScreen extends StatelessWidget {
  const FilmFestivalsScreen({super.key});

  static final List<Map<String, dynamic>> _festivals = [
    {'name': 'Cannes Film Festival',                   'iso': 'FR'},
    {'name': 'Berlin International Film Festival',     'iso': 'DE'},
    {'name': 'Venice International Film Festival',     'iso': 'IT'},
    {'name': 'Toronto International Film Festival',    'iso': 'CA'},
    {'name': 'Sundance Film Festival',                 'iso': 'US'},
  ];
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: const Icon(Icons.local_movies_outlined, color: Color(0xFF764BA2), size: 26),
                      ),
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          Text('Film Festivals',
                              style: const TextStyle(fontSize: 11, fontWeight: FontWeight.w600,
                                  color: Color(0xFF764BA2), letterSpacing: 0.6)),
                          const SizedBox(height: 3),
                          const Text('Global Film Festivals',
                              style: TextStyle(fontSize: 22, fontWeight: FontWeight.w900,
                                  color: Color(0xFF111827), letterSpacing: -0.5, height: 1.1)),
                          const SizedBox(height: 4),
                          Text('The "Big Five" film festivals', style: TextStyle(fontSize: 12, color: Colors.grey[500])),
                        ]),
                      ),
                      const SizedBox(width: 12),
                      // seen 뱃지 — progress pill
                      Consumer<LandmarksProvider>(builder: (context, provider, _) {
                        final seen = _festivals.where((m) => provider.visitedLandmarks.contains(m['name'])).length;
                          ...
                          Row(mainAxisSize: MainAxisSize.min, children: [
                            Text('$seen',
                                style: const TextStyle(fontSize: 26, fontWeight: FontWeight.w900,
                                    color: Color(0xFF764BA2), height: 1.0)),
                            Padding(
                              padding: const EdgeInsets.only(left: 3, top: 6),
                              child: Text(' / 5',
                                  style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600,
                                      color: const Color(0xFF764BA2).withOpacity(0.45), height: 1.0)),
                            ),
                          ]),
                          ...
                          SizedBox(
                            ...
                            child: ClipRRect(
                              ...
                              child: Stack(children: [
                                Container(height: 4, color: const Color(0xFF764BA2).withOpacity(0.12)),
                                FractionallySizedBox(
                                    widthFactor: pct,
                                    child: Container(height: 4, color: const Color(0xFF764BA2))),
                              ]),
                            ),
                          ),
                        ]);
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return GestureDetector(
                    onTap: () {
                      if (landmark != null) {
                        _showLandmarkDetailsModal(context, landmark, const Color(0xFF764BA2));
                      } else {
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: isVisited
                            ? Border.all(color: const Color(0xFF764BA2).withOpacity(0.5), width: 1.5)
                      ...
                      child: Row(children: [
                        ...
                        if (isVisited)
                          Container(
                              ...
                              decoration: BoxDecoration(color: const Color(0xFF764BA2).withOpacity(0.12), borderRadius: BorderRadius.circular(12)),
                              child: Text('Visited',
                                  style: TextStyle(fontSize: 11, color: const Color(0xFF764BA2), fontWeight: FontWeight.w700)))
                        else
